...
int main()
{
	...
	mainLight = DirectionalLight(1.0f, 1.0f, 1.0f,
		0.3f, 0.3f,//coeficientes de intensidad 
	...
	spotLights[0] = SpotLight(1.0f, 1.0f, 1.0f,
		0.0f, 2.0f,//coeficiente ambiental y difusa , 0 no ilumina a su alrededor 
		0.0f, 0.0f, 0.0f,//posicion
		0.0f, -1.0f, 0.0f,//apuntar a direccion
		1.0f, 0.0f, 0.0f,//l;imite de distancia de como puede iluminar 
		5.0f);//valor de 5, para indicar la apertura de la luz 
	spotLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//coche texturizado
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmuevex(), -0.95f, 5.0f));
		modelaux = model;
		...
		//model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmueve(), 5.0f, 6.0f)); 
		...
		model = modelaux;
		glm::vec3 carLightPos = model[3]; //og 3
		carLightPos.x += 2.2f;//mover la luz para adelante y para atras 
		carLightPos.z += 4.99f;//mover la luz de igual forma 
		spotLights[1].SetPos(carLightPos);
